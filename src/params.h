...
{
    std::cout << "\e[1m***Mobotix Thermal Data Downloader***\e[0m\n"
              ...
              << "\t-o,--output   \toutput files basename\t Relative path without extension\n\n"
              << "\e[1mExample:\e[0m\n"
              << "\t" << argv[0] << " --ip 0.0.0.0 --user admin --pass 'pass!@' --output ../output/a"
              << std::endl;
    exit(0);
}
