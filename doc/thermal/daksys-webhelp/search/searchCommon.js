...
/*            console.log( $('#lang').text().indexOf("cn")>0);*/
            if ( $('#lang').text().toLowerCase().indexOf("cn")>=0){
                headerHTML +=
                "搜到"+lastSearchResultItems.length + "条关于“" +
                "<span class=\"wh_search_expression\">" + lastSearchResult.originalSearchExpression + "</span>"+ "”的结果";
            }
            else{
            headerHTML +=
            ...
            if (linkTab.length > 2) {
                ...
                if ( $('#lang').text().toLowerCase().indexOf("cn")>=0){
                    results += "<div class='wh_search_results_for'>" +
                        "未搜到关于 " + "<span class=\"wh_search_expression\">" + lastSearchResult.originalSearchExpression + "</span>" + " 的记录" + "</div>";
                }else{
                    results += "<div class='wh_search_results_for'>" +
