...
$(document).ready(function () {
    ...
    if (!notLocalChrome) {
        ...
        if (confirm(warningMsg)) {
            ...
            var warningSign = '<span id="warningSign"><img src="daksys-webhelp/resources/img/warning.png" alt="warning" border="0"></span>';
...
function loadSearchResources() {
    if (typeof window.indexerLanguage == 'undefined') {
        var scripts = ["daksys-webhelp/search/htmlFileInfoList.js?uniqueId=20201230042224", "daksys-webhelp/search/index-1.js?uniqueId=20201230042224", "daksys-webhelp/search/index-2.js?uniqueId=20201230042224", "daksys-webhelp/search/index-3.js?uniqueId=20201230042224"];
        ...
        if (notLocalChrome) {
            ...
            try {
                ...
                $('#breadcrumbLinks a, #navigationLinks a').each(function () {
                    ...
                    // we generate from dksgen '../'s in from of link
